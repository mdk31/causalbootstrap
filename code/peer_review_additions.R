...
# Causal BLB
# 
# 7. For the simulations, I would like to see what happens in the case where: 
# 1. the variables aren’t independent, 
# 2. more variables are added, 
# 3. the Logit link is violated, 
# 4. Heterogeneity in the treatment effect is introduced. 
